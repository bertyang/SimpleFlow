...
namespace SimpleFlow.Entity
{
    ...
    /// form_list
    /// </summary>
    [SimpleFlow.DBFramework.SQLServer.Entity("form_list", typeof(FormListHelper))]
    public class FormList : SimpleFlow.DBFramework.SQLServer.IEntity
    {
        public FormList()
        {
        }
        public FormList(string _FormKind)
        {
            m_FormKind = _FormKind;
        }
