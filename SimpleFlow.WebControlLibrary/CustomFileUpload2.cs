...
namespace SimpleFlow.WebControlLibrary
{
    ...
    public class CustomFileUpload2 : WebControl, IPostBackDataHandler, INamingContainer
    {
        public CustomFileUpload2() : base(HtmlTextWriterTag.Table)
        {
        ...
        private string m_DownloadPage = "~/GeneralPage/TempAttachmentDownload.aspx";

        public string DownloadPage
        {
            get { return m_DownloadPage; }
            set { m_DownloadPage = value; }
        }
