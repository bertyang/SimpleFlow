...
var DEFAULT_DATE_SEPARATOR = DATE_SEPARATORS[[DEFAULT_DATE_SEPARATOR]];	// Value limited in array DATE_SEPARATORS.
var DEFAULT_DATE_FORMAT = "[DEFAULT_DATE_FORMAT]";				// Support yyyymmdd, mmddyyyy, ddmmyyyy
...
function calendar(t) 
{
	...
	var sPath =  GotRootPath() + "Scripts/calendar1.htm";
