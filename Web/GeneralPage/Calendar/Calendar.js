...
var DEFAULT_DATE_SEPARATOR = DATE_SEPARATORS[0];	// Value limited in array DATE_SEPARATORS.
...
function calendar(t, dateFormat, dateSpliter) 
{
	DEFAULT_DATE_FORMAT = dateFormat;
	DEFAULT_DATE_SEPARATOR = dateSpliter;
	
	// Set calendar1.htm path relative to current document.
	var sPath = "Calendar/calendar1.htm";
	if(typeof getCalendarPath == "function")
	{
		sPath += getCalendarPath();
	}
