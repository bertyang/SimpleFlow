<%@ Page Language="C#" MasterPageFile="~/DefaultMasterPage.master" AutoEventWireup="true"
    CodeFile="TraceFormDetail.aspx.cs" Inherits="TraceFormDetail" Title="Trace Form" %>
            ...
            <asp:GridView ID="GridView1" runat="server" Width="98%" OnRowDataBound="GridView1_RowDataBound"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Apply User">
                        <ItemTemplate>
                            <asp:Label ID="label_apply_user" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Filler") %>' />
                        </ItemTemplate>
                        <ItemStyle Width="15%"></ItemStyle>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Approve Status">
                        <ItemTemplate>
                            <asp:Label ID="label_approve_status" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "FormStatus") %>' />
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Modify">
                        <ItemTemplate>
                            <asp:ImageButton ID="button_modify" OnClick="button_modify_click" runat="server"
                                ImageUrl="~/Images/modify.gif"></asp:ImageButton>
                        </ItemTemplate>
                        <ItemStyle Width="7%"></ItemStyle>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Withdraw">
                        <ItemTemplate>
                            <asp:ImageButton ID="button_withdraw" OnClick="button_withdraw_click" runat="server"
                                ImageUrl="~/Images/undo.gif" OnClientClick="if (!window.confirm('Confirm withdraw?')) { return false; } ">
                            </asp:ImageButton>
                        </ItemTemplate>
                        <ItemStyle Width="10%"></ItemStyle>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Urge Inform">
                        <ItemTemplate>
                            <asp:ImageButton ID="button_urgent" runat="server" ImageUrl="~/Images/receivemail.gif"
                                OnClick="button_urgent_Click"></asp:ImageButton>
                        </ItemTemplate>
                        <ItemStyle Width="8%"></ItemStyle>
                    </asp:TemplateField>
                </Columns>
