...
class Sql2000DatabaseManager:
    def __init__(self, connn_str):
        self.connection_string = connn_str
        self._host = connn_str.host
        self._user = connn_str.user
        self._password = connn_str.password
        self._database = connn_str.database
    ...
    def __fill_columns(self, cur, table):
        ...
        for column_record in column_result:
            ...
            #c.data_type = mssql_nvarchar()
            #print column_record[3]
