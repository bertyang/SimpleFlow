...
{
    public class SysMenuLanguageInfoHelper : SimpleFlow.DBFramework.SQLServer.EntityHelper<SysMenuLanguageInfo>
    {
        public SysMenuLanguageInfoHelper()
        {
        }
        ...
        /// </summary>
        public override void Insert(string connection_string, SysMenuLanguageInfo entity)
        {
        ...
        ///  insert one SysMenuLanguage to database 
        /// </summary>
        public override void Insert(SqlConnection connection, SysMenuLanguageInfo entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("insert into [sys_menu_language] (");
            sb.Append("[menu_id],");
        ...
        ///  insert one SysMenuLanguage to database 
        /// </summary>
        public override void Insert(SqlTransaction transaction, SysMenuLanguageInfo entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("insert into [sys_menu_language] (");
            sb.Append("[menu_id],");
        ...
        /// </summary>
        public override void Update(string connection_string, SysMenuLanguageInfo entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
        ...
        /// the primary key is :menu_id/language_id/
        /// </summary>
        public override void Update(SqlConnection connection, SysMenuLanguageInfo entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("update [sys_menu_language] set ");
            sb.Append("[menu_name] = @MenuName ");
        ...
        /// the primary key is :menu_id/language_id/
        /// </summary>
        public override void Update(SqlTransaction transaction, SysMenuLanguageInfo entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("update [sys_menu_language] set ");
            sb.Append("[menu_name] = @MenuName ");
        ...
        /// the primary key is :menu_id/language_id/
        /// </summary>
        public override void Delete(string connection_string, SysMenuLanguageInfo entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
        ...
        /// the primary key is :menu_id/language_id/
        /// </summary>
        public override void Delete(SqlConnection connection, SysMenuLanguageInfo entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("delete from [sys_menu_language] ");
            sb.Append("where [menu_id] = @MenuId ");
        ...
        /// the primary key is :menu_id/language_id/
        /// </summary>
        public override void Delete(SqlTransaction transaction, SysMenuLanguageInfo entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("delete from [sys_menu_language] ");
            sb.Append("where [menu_id] = @MenuId ");
        ...
        public void FillEntityByRow(SysMenuLanguageInfo entity, System.Data.DataRow row)
        {
        ...
        /// <param name="row">a data row that include all the column of table(sys_menu_language)</param>
        /// <returns>an entity of SysMenuLanguage</returns>
        public override SysMenuLanguageInfo Row2Entity(System.Data.DataRow row)
        {
            SysMenuLanguageInfo entity = new SysMenuLanguageInfo();
        ...
        /// 
        /// </summary>
        public override SysMenuLanguageInfo Retrieve(SqlTransaction transaction, SysMenuLanguageInfo entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
        ...
        /// 
        /// </summary>
        public override SysMenuLanguageInfo Retrieve(SqlConnection connection, SysMenuLanguageInfo entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("select * from [sys_menu_language] ");
            sb.Append("where [menu_id] = @MenuId ");
        ...
        /// 
        /// </summary>
        public override SysMenuLanguageInfo Retrieve(string connection_string, SysMenuLanguageInfo entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("select * from [sys_menu_language] ");
            sb.Append("where [menu_id] = @MenuId ");
