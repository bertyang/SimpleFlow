...
class builder_manager:
    ...
    def build_to_directory(self, file_dir):
...
if __name__ == '__main__' : 
    ...
    build_mgr.build_to_directory('j:\My Documents\Visual Studio 2008\Projects\SimpleFlow\BuildEntityTools\Output')
