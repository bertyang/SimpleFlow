...
namespace SimpleFlow.Entity
{
    ...
    /// sys_site_list
    /// </summary>
    [SimpleFlow.DBFramework.SQLServer.Entity("sys_site_list", typeof(SysSiteListHelper))]
    public class SysSiteList : SimpleFlow.SystemFramework.IEntity
    {
        public SysSiteList()
        {
        }
        public SysSiteList(int _SiteSerial)
        {
