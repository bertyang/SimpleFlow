...
namespace SimpleFlow.Entity
{
    ...
    /// sys_attachment
    /// </summary>
    [SimpleFlow.DBFramework.SQLServer.Entity("sys_attachment", typeof(SysAttachmentHelper))]
    public class SysAttachment : SimpleFlow.SystemFramework.IEntity
    {
        public SysAttachment()
        {
        }
        public SysAttachment(string _AttachmentId)
        {
