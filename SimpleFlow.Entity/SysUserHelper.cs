...
{
    public class SysUserHelper : SimpleFlow.DBFramework.SQLServer.EntityHelper<SysUser>
    {
        ...
        /// </summary>
        public override void Insert(string connection_string, SysUser entity)
        {
            ...
            ParameterBuilder paramList = new ParameterBuilder(19);
        ...
        ///  insert one SysUser to database 
        /// </summary>
        public override void Insert(SqlConnection connection, SysUser entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("insert into [sys_user] (");
            sb.Append("[user_id],");
        ...
        ///  insert one SysUser to database 
        /// </summary>
        public override void Insert(SqlTransaction transaction, SysUser entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("insert into [sys_user] (");
            sb.Append("[user_id],");
        ...
        /// </summary>
        public override void Update(string connection_string, SysUser entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
        ...
        /// the primary key is :user_id/
        /// </summary>
        public override void Update(SqlConnection connection, SysUser entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("update [sys_user] set ");
            sb.Append("[domain_name] = @DomainName, ");
        ...
        /// the primary key is :user_id/
        /// </summary>
        public override void Update(SqlTransaction transaction, SysUser entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("update [sys_user] set ");
            sb.Append("[domain_name] = @DomainName, ");
        ...
        /// the primary key is :user_id/
        /// </summary>
        public override void Delete(string connection_string, SysUser entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
        ...
        /// the primary key is :user_id/
        /// </summary>
        public override void Delete(SqlConnection connection, SysUser entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("delete from [sys_user] ");
            sb.Append("where [user_id] = @UserId ");
        ...
        /// the primary key is :user_id/
        /// </summary>
        public override void Delete(SqlTransaction transaction, SysUser entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("delete from [sys_user] ");
            sb.Append("where [user_id] = @UserId ");
        ...
        public void FillEntityByRow(SysUser entity, System.Data.DataRow row)
        {
        ...
        /// <param name="row">a data row that include all the column of table(sys_user)</param>
        /// <returns>an entity of SysUser</returns>
        public override SysUser Row2Entity(System.Data.DataRow row)
        {
        ...
        /// 
        /// </summary>
        public override SysUser Retrieve(SqlTransaction transaction, SysUser entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
        ...
        /// 
        /// </summary>
        public override SysUser Retrieve(SqlConnection connection, SysUser entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("select * from [sys_user] ");
            sb.Append("where [user_id] = @UserId ");
        ...
        /// 
        /// </summary>
        public override SysUser Retrieve(string connection_string, SysUser entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("select * from [sys_user] ");
            sb.Append("where [user_id] = @UserId ");
