...
{
    public class SysExceptionLogHelper : SimpleFlow.DBFramework.SQLServer.EntityHelper<SysExceptionLog>
    {
        public SysExceptionLogHelper()
        {
        }
        ...
        /// </summary>
        public override void Insert(string connection_string, SysExceptionLog entity)
        {
        ...
        ///  insert one SysExceptionLog to database 
        /// </summary>
        public override void Insert(SqlConnection connection, SysExceptionLog entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("insert into [sys_exception_log] (");
            sb.Append("[log_id],");
        ...
        ///  insert one SysExceptionLog to database 
        /// </summary>
        public override void Insert(SqlTransaction transaction, SysExceptionLog entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("insert into [sys_exception_log] (");
            sb.Append("[log_id],");
        ...
        /// </summary>
        public override void Update(string connection_string, SysExceptionLog entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
        ...
        /// the primary key is :log_id/
        /// </summary>
        public override void Update(SqlConnection connection, SysExceptionLog entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("update [sys_exception_log] set ");
            sb.Append("[log_type] = @LogType, ");
        ...
        /// the primary key is :log_id/
        /// </summary>
        public override void Update(SqlTransaction transaction, SysExceptionLog entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("update [sys_exception_log] set ");
            sb.Append("[log_type] = @LogType, ");
        ...
        /// the primary key is :log_id/
        /// </summary>
        public override void Delete(string connection_string, SysExceptionLog entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
        ...
        /// the primary key is :log_id/
        /// </summary>
        public override void Delete(SqlConnection connection, SysExceptionLog entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("delete from [sys_exception_log] ");
            sb.Append("where [log_id] = @LogId ");
        ...
        /// the primary key is :log_id/
        /// </summary>
        public override void Delete(SqlTransaction transaction, SysExceptionLog entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("delete from [sys_exception_log] ");
            sb.Append("where [log_id] = @LogId ");
        ...
        public void FillEntityByRow(SysExceptionLog entity, System.Data.DataRow row)
        {
        ...
        /// <param name="row">a data row that include all the column of table(sys_exception_log)</param>
        /// <returns>an entity of SysExceptionLog</returns>
        public override SysExceptionLog Row2Entity(System.Data.DataRow row)
        {
        ...
        /// 
        /// </summary>
        public override SysExceptionLog Retrieve(SqlTransaction transaction, SysExceptionLog entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
        ...
        /// 
        /// </summary>
        public override SysExceptionLog Retrieve(SqlConnection connection, SysExceptionLog entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("select * from [sys_exception_log] ");
            sb.Append("where [log_id] = @LogId ");
        ...
        /// 
        /// </summary>
        public override SysExceptionLog Retrieve(string connection_string, SysExceptionLog entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("select * from [sys_exception_log] ");
            sb.Append("where [log_id] = @LogId ");
