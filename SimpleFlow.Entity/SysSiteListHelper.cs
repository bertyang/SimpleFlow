...
{
    public class SysSiteListHelper : SimpleFlow.DBFramework.SQLServer.EntityHelper<SysSiteList>
    {
        public SysSiteListHelper()
        {
        }
        ...
        /// </summary>
        public override void Insert(string connection_string, SysSiteList entity)
        {
        ...
        ///  insert one SysSiteList to database 
        /// </summary>
        public override void Insert(SqlConnection connection, SysSiteList entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("insert into [sys_site_list] (");
            sb.Append("[site_serial],");
        ...
        ///  insert one SysSiteList to database 
        /// </summary>
        public override void Insert(SqlTransaction transaction, SysSiteList entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("insert into [sys_site_list] (");
            sb.Append("[site_serial],");
        ...
        /// </summary>
        public override void Update(string connection_string, SysSiteList entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
        ...
        /// the primary key is :site_serial/
        /// </summary>
        public override void Update(SqlConnection connection, SysSiteList entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("update [sys_site_list] set ");
            sb.Append("[site_name] = @SiteName, ");
        ...
        /// the primary key is :site_serial/
        /// </summary>
        public override void Update(SqlTransaction transaction, SysSiteList entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("update [sys_site_list] set ");
            sb.Append("[site_name] = @SiteName, ");
        ...
        /// the primary key is :site_serial/
        /// </summary>
        public override void Delete(string connection_string, SysSiteList entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
        ...
        /// the primary key is :site_serial/
        /// </summary>
        public override void Delete(SqlConnection connection, SysSiteList entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("delete from [sys_site_list] ");
            sb.Append("where [site_serial] = @SiteSerial ");
        ...
        /// the primary key is :site_serial/
        /// </summary>
        public override void Delete(SqlTransaction transaction, SysSiteList entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("delete from [sys_site_list] ");
            sb.Append("where [site_serial] = @SiteSerial ");
        ...
        public void FillEntityByRow(SysSiteList entity, System.Data.DataRow row)
        {
        ...
        /// <param name="row">a data row that include all the column of table(sys_site_list)</param>
        /// <returns>an entity of SysSiteList</returns>
        public override SysSiteList Row2Entity(System.Data.DataRow row)
        {
            SysSiteList entity = new SysSiteList();
        ...
        /// 
        /// </summary>
        public override SysSiteList Retrieve(SqlTransaction transaction, SysSiteList entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
        ...
        /// 
        /// </summary>
        public override SysSiteList Retrieve(SqlConnection connection, SysSiteList entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("select * from [sys_site_list] ");
            sb.Append("where [site_serial] = @SiteSerial ");
        ...
        /// 
        /// </summary>
        public override SysSiteList Retrieve(string connection_string, SysSiteList entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("select * from [sys_site_list] ");
            sb.Append("where [site_serial] = @SiteSerial ");
