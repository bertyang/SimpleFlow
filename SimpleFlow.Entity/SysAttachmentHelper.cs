...
{
    public class SysAttachmentHelper : SimpleFlow.DBFramework.SQLServer.EntityHelper<SysAttachment>
    {
        public SysAttachmentHelper()
        {
        }
        ...
        /// </summary>
        public override void Insert(string connection_string, SysAttachment entity)
        {
        ...
        ///  insert one SysAttachment to database 
        /// </summary>
        public override void Insert(SqlConnection connection, SysAttachment entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("insert into [sys_attachment] (");
            sb.Append("[attachment_id],");
        ...
        ///  insert one SysAttachment to database 
        /// </summary>
        public override void Insert(SqlTransaction transaction, SysAttachment entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("insert into [sys_attachment] (");
            sb.Append("[attachment_id],");
        ...
        /// </summary>
        public override void Update(string connection_string, SysAttachment entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
        ...
        /// the primary key is :attachment_id/
        /// </summary>
        public override void Update(SqlConnection connection, SysAttachment entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("update [sys_attachment] set ");
            sb.Append("[original_file_name] = @OriginalFileName, ");
        ...
        /// the primary key is :attachment_id/
        /// </summary>
        public override void Update(SqlTransaction transaction, SysAttachment entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("update [sys_attachment] set ");
            sb.Append("[original_file_name] = @OriginalFileName, ");
        ...
        /// the primary key is :attachment_id/
        /// </summary>
        public override void Delete(string connection_string, SysAttachment entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
        ...
        /// the primary key is :attachment_id/
        /// </summary>
        public override void Delete(SqlConnection connection, SysAttachment entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("delete from [sys_attachment] ");
            sb.Append("where [attachment_id] = @AttachmentId ");
        ...
        /// the primary key is :attachment_id/
        /// </summary>
        public override void Delete(SqlTransaction transaction, SysAttachment entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("delete from [sys_attachment] ");
            sb.Append("where [attachment_id] = @AttachmentId ");
        ...
        public void FillEntityByRow(SysAttachment entity, System.Data.DataRow row)
        {
        ...
        /// <param name="row">a data row that include all the column of table(sys_attachment)</param>
        /// <returns>an entity of SysAttachment</returns>
        public override SysAttachment Row2Entity(System.Data.DataRow row)
        {
        ...
        /// 
        /// </summary>
        public override SysAttachment Retrieve(SqlTransaction transaction, SysAttachment entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
        ...
        /// 
        /// </summary>
        public override SysAttachment Retrieve(SqlConnection connection, SysAttachment entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("select * from [sys_attachment] ");
            sb.Append("where [attachment_id] = @AttachmentId ");
        ...
        /// 
        /// </summary>
        public override SysAttachment Retrieve(string connection_string, SysAttachment entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("select * from [sys_attachment] ");
            sb.Append("where [attachment_id] = @AttachmentId ");
