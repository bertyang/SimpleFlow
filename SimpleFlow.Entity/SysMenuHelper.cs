...
{
    public class SysMenuHelper : SimpleFlow.DBFramework.SQLServer.EntityHelper<SysMenu>
    {
        public SysMenuHelper()
        {
        }
        ...
        /// </summary>
        public override void Insert(string connection_string, SysMenu entity)
        {
        ...
        ///  insert one SysMenu to database 
        /// </summary>
        public override void Insert(SqlConnection connection, SysMenu entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("insert into [sys_menu] (");
            sb.Append("[menu_id],");
        ...
        ///  insert one SysMenu to database 
        /// </summary>
        public override void Insert(SqlTransaction transaction, SysMenu entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("insert into [sys_menu] (");
            sb.Append("[menu_id],");
        ...
        /// </summary>
        public override void Update(string connection_string, SysMenu entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
        ...
        /// the primary key is :menu_id/
        /// </summary>
        public override void Update(SqlConnection connection, SysMenu entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("update [sys_menu] set ");
            sb.Append("[menu_name] = @MenuName, ");
        ...
        /// the primary key is :menu_id/
        /// </summary>
        public override void Update(SqlTransaction transaction, SysMenu entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("update [sys_menu] set ");
            sb.Append("[menu_name] = @MenuName, ");
        ...
        /// the primary key is :menu_id/
        /// </summary>
        public override void Delete(string connection_string, SysMenu entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
        ...
        /// the primary key is :menu_id/
        /// </summary>
        public override void Delete(SqlConnection connection, SysMenu entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("delete from [sys_menu] ");
            sb.Append("where [menu_id] = @MenuId ");
        ...
        /// the primary key is :menu_id/
        /// </summary>
        public override void Delete(SqlTransaction transaction, SysMenu entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("delete from [sys_menu] ");
            sb.Append("where [menu_id] = @MenuId ");
        ...
        /// <param name="row">a data row that include all the column of table(sys_menu)</param>
        /// <returns>an entity of SysMenu</returns>
        public override SysMenu Row2Entity(System.Data.DataRow row)
        {
        ...
        /// 
        /// </summary>
        public override SysMenu Retrieve(SqlTransaction transaction, SysMenu entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
        ...
        /// 
        /// </summary>
        public override SysMenu Retrieve(SqlConnection connection, SysMenu entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("select * from [sys_menu] ");
            sb.Append("where [menu_id] = @MenuId ");
        ...
        /// 
        /// </summary>
        public override SysMenu Retrieve(string connection_string, SysMenu entity)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("select * from [sys_menu] ");
            sb.Append("where [menu_id] = @MenuId ");
