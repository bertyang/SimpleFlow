...
namespace SimpleFlow.Entity
{
    ...
    /// sys_user
    /// </summary>
    [SimpleFlow.DBFramework.SQLServer.Entity("sys_user", typeof(SysUserHelper))]
    public class SysUser : SimpleFlow.SystemFramework.IEntity
    {
        public SysUser()
        {
        }
        public SysUser(string _UserId)
        {
            m_UserId = _UserId;
        }
