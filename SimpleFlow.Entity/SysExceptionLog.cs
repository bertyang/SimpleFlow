...
namespace SimpleFlow.Entity
{
    ...
    /// sys_exception_log
    /// </summary>
    [SimpleFlow.DBFramework.SQLServer.Entity("sys_exception_log", typeof(SysExceptionLogHelper))]
    public class SysExceptionLog : SimpleFlow.SystemFramework.IEntity
    {
        public SysExceptionLog()
        {
        }
        public SysExceptionLog(string _LogId)
        {
            m_LogId = _LogId;
        }
